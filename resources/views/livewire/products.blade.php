                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{$product->reference}}</h2>
                                                    <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{{$product->name}}</p>
                                                </div>
                                            </td>
                                            ...
                                            {{-- <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                ...
                                                {{-- pueden ser las imágenes del producto --}}
